...
#PBS -N generator_atlas_ft_4gpu
#PBS -o generator_atlas_ft_4gpu.log
...
# PyTorch memory behavior (important for long context)
...
export WANDB_NAME=atlas_ft_4gpu
export WANDB_MODE=offline   # NSCC 推荐（如需 online 可改）

# =========================================================
# Activate conda environment
# =========================================================

source /home/users/ntu/xu0029ng/scratch/conda_envs/Generator/bin/activate

# Sanity check (will be printed into log)
...
# =========================================================
# Go to GENERator repo
# =========================================================

cd /home/users/ntu/xu0029ng/scratch/GENERator

# =========================================================
# Launch training (4 GPU, DeepSpeed)
# =========================================================
...
torchrun \
  ...
  src/tasks/downstream/fine_tuning.py \
    ...
    --learning_rate 1e-5 \
    --num_train_epochs 1 \
    --output_dir results/atlas_ft_4gpu \
